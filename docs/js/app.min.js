...
// Add assessments
for(i=0;i<$scope.assessments.length;i++)"Hard"!==$scope.assessments[i].Mastery&&"Placement"!==$scope.assessments[i].Mastery&&data.addRow([new Date($scope.assessments[i].Date),$rootScope.getNumericalReadingLevel($scope.assessments[i].TextLevel),null]);var options={
// vAxis: {
//   title: 'Reading Level'
// },
